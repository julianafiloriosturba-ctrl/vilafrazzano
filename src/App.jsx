            ...
            <form onSubmit={enviar}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="nome" defaultValue="" style={inp} placeholder="Nome completo" type="text" required autoComplete="name"/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="cpf" defaultValue="" style={inp} placeholder="000.000.000-00" type="text" required inputMode="numeric"/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="nasc" defaultValue="" style={inp} type="date" required/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="tel" defaultValue="" style={inp} placeholder="(85) 99999-9999" type="tel" required autoComplete="tel"/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="email" defaultValue="" style={inp} placeholder="email@exemplo.com" type="email" required autoComplete="email"/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <input name="end" defaultValue="" style={inp} placeholder="Fortaleza, CE" type="text" required/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <select name="qtd" defaultValue="1" style={inp} required onChange={e=>setNumAcomp(Math.max(0,parseInt(e.target.value)-1))}>
                ...
                <div style={{marginBottom:10}}>
                  ...
                  <select name="quarto" defaultValue="" style={inp} required>
                ...
                <div style={{marginBottom:10}}>
                  ...
                  <input name="chegada" defaultValue="" style={inp} type="date" required/>
                </div>
                <div style={{marginBottom:10}}>
                  ...
                  <select name="hora" defaultValue="" style={inp} required>
                    <option value="">Selecione...</option>
                    ...
                    <div key={`acomp-${i}`} style={{background:"#f4efe6",borderRadius:8,padding:14,marginBottom:10}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:9}}>
                        <div style={{marginBottom:10}}>
                          ...
                          <input name={`ac_nome_${i}`} defaultValue="" style={inp} placeholder="Nome completo" type="text" required/>
                        </div>
                        <div style={{marginBottom:10}}>
                          <label style={{fontSize:".62rem",fontWeight:700,letterSpacing:".1em",textTransform:"uppercase",color:"#7a6450",display:"block",marginBottom:3}}>CPF *</label>
                          <input name={`ac_cpf_${i}`} defaultValue="" style={inp} placeholder="000.000.000-00" type="text" required inputMode="numeric"/>
                        </div>
                        <div style={{marginBottom:10}}>
                          <label style={{fontSize:".62rem",fontWeight:700,letterSpacing:".1em",textTransform:"uppercase",color:"#7a6450",display:"block",marginBottom:3}}>E-mail</label>
                          <input name={`ac_email_${i}`} defaultValue="" style={inp} placeholder="email@exemplo.com" type="email"/>
                        </div>
                        <div style={{marginBottom:10}}>
                          ...
                          <select name={`ac_quarto_${i}`} defaultValue="" style={inp}>
                            <option value="">Selecione...</option>
                            {QUARTOS.map(q=><option key={q} value={q}>{q}</option>)}
                          </select>
                        </div>
              ...
              <div style={{marginTop:18}}>
                ...
                {Array.from({length:numPlacas}).map((_,i)=>(
                  <div key={`placa-${i}`} style={{display:"flex",gap:8,marginBottom:8}}>
                    <input name={`placa_${i}`} defaultValue="" style={{...inp,textTransform:"uppercase"}} placeholder={i===0?"ABC-1234":"ABC-1234 (opcional)"} type="text"/>
                    {numPlacas>1&&i===numPlacas-1&&(
                      <button type="button" onClick={()=>setNumPlacas(p=>Math.max(1,p-1))} style={{background:"none",border:"none",color:"#aaa",cursor:"pointer",fontSize:"1.1rem"}}>✕</button>
                    )}
                  </div>
                ))}
                {numPlacas<5&&(
